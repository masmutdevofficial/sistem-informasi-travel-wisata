        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Kelola Driver</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card card-outline card-primary">
                        ...
                        <div class="d-flex flex-row justify-content-between align-items-center">
                            ...
                            <div class="d-flex flex-row justify-content-center align-items-center">
                                <button class="btn btn-primary mr-2" data-toggle="modal" data-target="#modalTambahBasic">
                                    <i class="fa fa-plus mr-2"></i>Tambah Driver
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                    <?php
                    $query = mysqli_query($koneksi, "SELECT * FROM data_driver ORDER BY id DESC");
                    ?>
                    ...
                    <table id="basicTable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= htmlspecialchars($row['rute_biasa']) ?></td>
                                <td><?= htmlspecialchars($row['jadwal_kerja']) ?></td>
                                <td>
                            ...
                            <div class="modal fade" id="modalEdit<?= $row['id'] ?>" tabindex="-1">
                                <div class="modal-dialog">
                                    <form action="proses/edit_driver.php" method="POST">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    <label>No HP</label>
                                                    <input type="text" name="hp" value="<?= htmlspecialchars($row['hp']) ?>"
                                                        class="form-control" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label>Rute Biasa</label>
                                                    <input type="text" name="rute_biasa" value="<?= htmlspecialchars($row['rute_biasa']) ?>"
                                                        class="form-control" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label>Jadwal Kerja</label>
                                                    <input type="text" name="jadwal_kerja" value="<?= htmlspecialchars($row['jadwal_kerja']) ?>"
                                                        class="form-control" required>
                                                </div>
                                            </div>
                            ...
                            <div class="modal fade" id="modalHapus<?= $row['id'] ?>" tabindex="-1">
                                <div class="modal-dialog">
                                    <form action="proses/hapus_driver.php" method="POST">
                                        <input type="hidden" name="id" value="<?= $row['id'] ?>">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-body">
                                                Yakin ingin menghapus data driver
