            ...
            <div class="col-12">
                ...
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-body">
                        ...
                        ?>
                        <table id="basicTable" class="table table-bordered table-striped" id="basicTable">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Username</th>
                                        ...
                                        <form action="proses/edit_admin.php" method="POST">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        <label>HP</label>
                                                        <input type="text" name="hp" value="<?= htmlspecialchars($row['hp']) ?>" class="form-control" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label>Status</label>
                                    ...
                                    <div class="modal-dialog">
                                        <form action="proses/hapus_admin.php" method="POST">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    Yakin ingin menghapus admin <strong><?= htmlspecialchars($row['nama']) ?></strong>?
                                                </div>
                                                <div class="modal-footer">
